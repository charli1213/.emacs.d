...
\usepackage[backend=biber,style=ieee,sorting=ynt]{biblatex} % N'est pas utilisé par le compilateur org-mode, mais NÉCESSAIRE. Voir le fichier init.el pour changer le style. 
